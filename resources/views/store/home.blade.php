            ...
            <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
              <div class="ps-masonry">
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        ...
                        <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/1.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                ...
                <div class="grid-item nike">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="grid-item adidas">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="grid-item men">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="grid-item women">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/6.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/7.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/8.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/1.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div>
                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}" alt=""></div>
